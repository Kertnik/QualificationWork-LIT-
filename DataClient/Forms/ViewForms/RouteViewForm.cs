...
namespace DataClient.Forms.ViewForms
{
    public partial class RouteViewForm : Form
    {
        ...
        CartesianChart locChart;

        public RouteViewForm(Form parent)
        {
            this.parent = parent;
            InitializeComponent();
        ...
        private void TypeOfRoutesList_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void RoutesListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            using (var db = new TgBotContext())
            {
                ...
                else
                {
                    ...
                    Total.Text = "Усього пасажирів:" + arr.Sum()+"\n"+"Водій:"+route.MyDriver.Name+$" ({route.MyDriver.DriverId})";
